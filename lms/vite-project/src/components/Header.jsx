...
const Header = () => {
  return (
    <header className="p-4  bg-gray-950 text-gray-50">
	<div className="container flex justify-between h-16 mx-auto">
		...
		<div className="flex items-center md:space-x-4">
			...
			<button type="button" className="px-8 py-3 font-semibold rounded-full dark:bg-gray-800 btn btn-outline btn-secondary dark:text-gray-100">Sign in</button>
			
			<button type="button" className="px-8 py-3 font-semibold rounded-full dark:bg-gray-800 btn btn-outline btn-secondary dark:text-gray-100">Login</button>
		</div>
